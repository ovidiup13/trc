...
- If `AWS_ACCESS_KEY_ID` and `AWS_SECRET_ACCESS_KEY` are set, TRC will use those instead of the config file values.
- Any S3 config field can reference an environment variable using `$NAME`.
